...
/**
 * Formats an array of populatedAuthors from Stories into a prettified string.
 * @param authors - The populatedAuthors array from a Story.
...
export const formatAuthors = (
  authors: NonNullable<NonNullable<Story['populatedAuthors']>[number]>[],
) => {
