    ...
    <section className="py-20 lg:py-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
          <div className="order-2 lg:order-1 flex flex-col">
            ...
            <div className="mb-12 flex flex-row items-center gap-8">
              ...
              <div>
                ...
                <p className="text-body font-normal text-muted-foreground">{location}</p>
              </div>
            </div>
            {buttonLink && (
              <Link
                href={buttonLink}
                className="font-medium text-base group inline-block w-fit text-primary"
              >
          ...
          <div className="order-1 lg:order-2 flex h-full w-full rounded-md overflow-hidden items-center justify-center">
            <Media resource={image} className="h-auto w-full object-cover" />
          </div>
        </div>
      </div>
    </section>
